...
public class SparkIgniteEx {
	static String CONFIG = "example-ignite.xml";
	static String CACHE_NAME = "testCache";
	public static void main(String[] args) {
		...
		SparkConf sparkConf = new SparkConf().setMaster("local[4]").setAppName("Spark Ignite");
	...
	/*	JavaSparkContext sparkContext = new JavaSparkContext(sparkConf);
		...
		// -- ignite context
		JavaIgniteContext<Integer, Integer> ic = new JavaIgniteContext<Integer, Integer>(sparkContext, cfg, false);
...
*/
	   ...
	   private static void writeJSonToIgnite(Ignite ignite, SparkSession spark) {
	        ...
	        Dataset<Row> personsDataFrame = spark.read().json(resolveIgnitePath("C:/Users/shubhamrai/eclipse-workspace-Testing/SparkIgnite/src/main/resources/person.json").getAbsolutePath());
